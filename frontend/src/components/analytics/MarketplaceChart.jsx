...
const MarketplaceChart = ({ data, isLoading }) => {
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            <Legend
              ...
              iconSize={10}
            />
            <Bar dataKey="Created" fill={colors.primary} radius={[2, 2, 0, 0]} />
            <Bar dataKey="Completed" fill={colors.success} radius={[2, 2, 0, 0]} />
            <Bar dataKey="Disputed" fill={colors.error} radius={[2, 2, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
