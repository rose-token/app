...
const TokenDistributionChart = () => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        {/* Worker Card */}
        <div className="bg-background border-2 border rounded-lg p-4">
      ...
      <div className="mt-4 p-4 bg-card rounded-lg text-sm text-muted">
        ...
        <div className="space-y-1 text-xs">
          ...
          <p className="pt-2 border-t border mt-2">
