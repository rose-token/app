        ...
        <div className="bg-accent/10 border-2 border-accent rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center">
              ...
              <p className="text-sm font-semibold text-accent-foreground">Worker</p>
            </div>
            <span className="text-2xl font-bold text-accent">95%</span>
          </div>
          <p className="text-xs text-muted-foreground">of distribution pot</p>
          <p className="text-xs text-accent font-medium mt-1">9.5 ROSE (for 10 ROSE task)</p>
        </div>
        ...
        <div className="bg-primary/10 border-2 border-primary rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center">
              ...
              <p className="text-sm font-semibold text-primary">Stakeholder</p>
            </div>
            <span className="text-2xl font-bold text-primary">5%</span>
          </div>
          <p className="text-xs text-muted-foreground">fee + 10% stake back</p>
          <p className="text-xs text-primary font-medium mt-1">1.5 ROSE total (50% ROI)</p>
        </div>

        {/* DAO Treasury Card */}
        <div className="bg-secondary/30 border-2 border-secondary rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center">
              <div className="w-3 h-3 bg-secondary rounded-full mr-2"></div>
              <p className="text-sm font-semibold text-secondary-foreground">DAO Treasury</p>
            </div>
            <span className="text-2xl font-bold text-rose-mauve">2%</span>
          </div>
          <p className="text-xs text-muted-foreground">minted tokens</p>
          <p className="text-xs text-rose-mauve font-medium mt-1">0.2 ROSE (creates inflation)</p>
        </div>
      </div>

      <div className="mt-4 p-4 bg-rose-blush rounded-lg text-sm text-foreground">
        ...
        <div className="space-y-1 text-xs">
          ...
          <p className="pt-2 border-t border-rose-tan mt-2">
