    ...
    <div className="min-h-screen flex relative z-[1]">
      ...
      <div className="flex-1 flex flex-col md:ml-64">
        ...
        <footer className="py-6 text-center text-xs border-t border-[rgba(255,255,255,0.08)]" style={{ color: 'var(--text-muted)' }}>
          <p>© 2025 Rose Labs, Inc. · Licensed under the <a href="https://spdx.org/licenses/PPL.html" className="hover:underline" style={{ color: 'var(--rose-pink)' }}>Peer Production License (PPL)</a></p>
        </footer>
      </div>
    </div>
  );
